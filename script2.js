...
function getPlayerChoice(e) {
  ...
  gameMessage.appendChild(div2).textContent = `Computer chose : ${computerChoice}`;
...
function decideWinner() {
  ...
  if (message.substr(0, 8) === "You Win!") {
    playerScore++;
    gameMessage.parentNode.insertBefore(div3,gameMessage).textContent = 'Game result :  You won.';
  } 
  else if (message.substr(0, 9) == "You Lose!") {
    computerScore++;
    gameMessage.parentNode.insertBefore(div3,gameMessage).textContent = 'Game result :  You lose.';
  }
  else
  {
    gameMessage.parentNode.insertBefore(div3,gameMessage).textContent = 'Game result :  Tie.';
  }
...
div3.style.cssText = 'font-size : 24px; font-weight: bold;margin: 16px 0; padding: 0';
